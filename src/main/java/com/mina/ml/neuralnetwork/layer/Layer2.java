...
public abstract class Layer2 {
    ...
    private final static Logger logger = LoggerFactory.getLogger(Layer2.class);
    ...
    protected Layer2 previousLayer;
    protected Layer2 nextLayer;
    ...
    public Layer2(String layerName, int numOfInputs, int numOfOutputs, String activationFunctionName, double learningRate) {
    ...
    /* for Input layer */
    public Layer2(String layerName, int numOfInputs) {
        this.layerName = layerName;
        this.numOfInputs = numOfInputs;
    }
...
//        MatrixManipulator.debugMatrix("accumulateDeltaWeights", deltaWeight);
    ...
    public Layer2 input(double[][] input) {
        this.input = input;
//        MatrixManipulator.debugMatrix(layerName + " received input: ", input);
    ...
    public void setPreviousLayer(Layer2 layer) {
        previousLayer = layer;
    }

    public void setNextLayer(Layer2 layer) {
        nextLayer = layer;
    }
