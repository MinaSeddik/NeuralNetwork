...
public class MatrixSpliterator<E> extends AbstractSpliterator<List<E>> {
    ...
    public MatrixSpliterator(Spliterator<E> toWrap, Function<? super E, ?> partitionBy) {
    ...
    public static <E> Stream<List<E>> partitionBy(
        ...
        return StreamSupport.stream(
                new MatrixSpliterator<>(in.spliterator(), partitionBy), false);
    }
    ...
    private Comparator<List<E>> comparator() {
        @SuppressWarnings({"unchecked", "rawtypes"}) final Comparator<? super E> innerComparator =
